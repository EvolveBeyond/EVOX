...
class AuthConfig:
    ...
    def __init__(self):
        self.secret_key = "evoid-secret-key-change-in-production"  # Should be loaded from env
        self.algorithm = "HS256"
        self.token_expiration = 3600  # 1 hour
        self.refresh_token_expiration = 86400  # 24 hours
        self.internal_token_secret = "evoid-internal-secret-change-in-production"
...
class AuthManager:
    ...
    def verify_internal_token(self, token: str) -> dict[str, Any]:
        ...
        try:
            ...
            if payload.get("iss") != "evoid-internal":
