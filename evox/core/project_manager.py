...
'''
        ...
        (target_path / "README.md").write_text(f"# {name}\n\nEVOX project created with `evox new {name}`\n")
        
        # Create config.toml
        config_content = '''# EVOX Project Configuration
...
'''
    ...
    def create_service(self, name: str, services_path: Path | None = None) -> bool:
        """
        Create a new EVOX service with the specified name.
        ...
        main_py_content = f'''"""
{name} Service - Generated by EVOX
"""
